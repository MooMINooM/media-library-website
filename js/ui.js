...
// 6. ผลงาน (Achievements) ✅ แก้ไขใหม่: รายการแข่ง + รายการ ขึ้นบรรทัดใหม่
            ...
            <div class="p-5 flex-grow flex flex-col gap-2">
                <div>
                    ...
                    <div class="flex flex-col gap-1 border-l-2 border-blue-100 pl-3">
                        ${item.competition ? `<div class="text-sm font-semibold text-blue-600"><i class="fa-solid fa-trophy mr-1"></i>${item.competition}</div>` : ''}
