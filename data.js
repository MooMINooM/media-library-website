...
export const STATIC_SCHOOL_BOARD_DATA = [
    { name: 'ประธานกรรมการ', role: 'ประธานกรรมการสถานศึกษา', imageUrl: 'YOUR_IMAGE_URL_HERE' },
];

// --- Static data for Student Information ---
export const STATIC_STUDENT_DATA = [
     { grade: 'อนุบาล 2', boys: 2, girls: 7, total: 9 },
    { grade: 'อนุบาล 3', boys: 11, girls: 7, total: 18 },
    { grade: 'ประถมศึกษาปีที่ 1', boys: 14, girls: 10, total: 24 },
    { grade: 'ประถมศึกษาปีที่ 2', boys: 8, girls: 11, total: 19 },
    { grade: 'ประถมศึกษาปีที่ 3', boys: 14, girls: 8, total: 22 },
    { grade: 'ประถมศึกษาปีที่ 4', boys: 12, girls: 8, total: 20 },
    { grade: 'ประถมศึกษาปีที่ 5', boys: 6, girls: 14, total: 20 },
    { grade: 'ประถมศึกษาปีที่ 6', boys: 12, girls: 9, total: 21 },
    { grade: 'มัธยมศึกษาปีที่ 1', boys: 7, girls: 8, total: 15 },
